...
keys = [
    'Kepler_planets', 'nonKepler_planets', 'Roman_line',
    'Kepler_line', 'Solar_System_planets', 'Solar_System_moons',
    'print_Kepler']

#keys_skip = [
#    'Roman_sensitivity', 'Roman_planets', 'Roman_line', 'print_Roman']
...
if plot.get('Roman_sensitivity', False):
...
if plot.get('Kepler_planets', False):
...
#Non-Kepler planets
if plot.get('nonKepler_planets', False):
...
if plot.get('Roman_planets', False):
...
planetsize=0.1
if plot.get('Solar_System_planets', False):
...
if plot.get('Solar_System_moons', False):
...
if plot.get('print_Kepler', False):
    ax.text(0.011,0.085,'$Kepler$',color='r',rotation=23)

if plot.get('print_Roman', False):
...
if plot.get('Roman_sensitivity', False) or plot.get('Roman_line', False):
    if plot.get('Roman_sensitivity', False):
